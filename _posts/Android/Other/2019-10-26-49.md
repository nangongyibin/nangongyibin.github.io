...
6. [ubuntu18.04无法安装libesd0-dev【学习笔记】](https://blog.csdn.net/weixin_34248258/article/details/86028896 "")
7. [编译错误-build stopped: subcommand failed. 解决方法](https://blog.csdn.net/touxiong/article/details/86233805 "")
8. [ubuntu18.04无法安装libesd0-dev【学习笔记】](https://www.cnblogs.com/zzb-Dream-90Time/p/10080408.html "")
9. [build/envsetup.sh分析](https://blog.csdn.net/daoshuti/article/details/72418094 "")
10. [Ubuntu 报错信息 recipe for target 'run_soong_ui' failed make: *** [run_soong_ui] Error 1](https://blog.csdn.net/qq_21445563/article/details/92077709 "")
11. [编译Android7源码出现:ninja: build stopped: subcommand failed.错误](https://blog.csdn.net/zhaohuarong/article/details/80662197 "")
12. [[git error] RPC failed; curl 56 GnuTLS recv error (-110): The TLS connection was non-properly ter...](https://www.jianshu.com/p/f5e3362db219 "")
13. [E:Unable to locate package libssl-dev:i386](https://blog.csdn.net/weixin_41572450/article/details/90257995 "")
14. [Sub-process /usr/bin/dpkg returned an error code (1)](https://blog.csdn.net/qq_38375620/article/details/86707493 "")
15. [ubuntu16.04 dpkg: error processing package *** (--configure): 大量包依赖错误](https://blog.csdn.net/w294954902/article/details/82906676 "")
16. [解决 FAILED: /bin/bash -c "prebuilts/misc/linux-x86/bison/bison -d](https://blog.csdn.net/liangtianmeng/article/details/85911177 "")
17. [[RK3399] Jack server installation not found](https://www.cnblogs.com/lialong1st/p/11491351.html "")
